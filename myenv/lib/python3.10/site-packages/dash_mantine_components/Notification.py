...
- title (a list of or a singular dash component, string or number; optional):
    ...
    _type = 'Notification'
    @_explicitize_args
    def __init__(self, color=Component.UNDEFINED, radius=Component.UNDEFINED, icon=Component.UNDEFINED, title=Component.UNDEFINED, message=Component.REQUIRED, loading=Component.UNDEFINED, disallowClose=Component.UNDEFINED, id=Component.REQUIRED, autoClose=Component.UNDEFINED, action=Component.REQUIRED, className=Component.UNDEFINED, style=Component.UNDEFINED, styles=Component.UNDEFINED, unstyled=Component.UNDEFINED, sx=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'action', 'autoClose', 'className', 'color', 'disallowClose', 'icon', 'loading', 'message', 'radius', 'style', 'styles', 'sx', 'title', 'unstyled']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'action', 'autoClose', 'className', 'color', 'disallowClose', 'icon', 'loading', 'message', 'radius', 'style', 'styles', 'sx', 'title', 'unstyled']
