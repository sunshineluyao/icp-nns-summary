...
- zIndex (number; optional):
    ...
    _type = 'HoverCard'
    @_explicitize_args
    def __init__(self, children=None, openDelay=Component.UNDEFINED, closeDelay=Component.UNDEFINED, position=Component.UNDEFINED, offset=Component.UNDEFINED, transition=Component.UNDEFINED, transitionDuration=Component.UNDEFINED, exitTransitionDuration=Component.UNDEFINED, width=Component.UNDEFINED, withArrow=Component.UNDEFINED, arrowSize=Component.UNDEFINED, arrowOffset=Component.UNDEFINED, arrowRadius=Component.UNDEFINED, withinPortal=Component.UNDEFINED, disabled=Component.UNDEFINED, returnFocus=Component.UNDEFINED, zIndex=Component.UNDEFINED, radius=Component.UNDEFINED, shadow=Component.UNDEFINED, middlewares=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, styles=Component.UNDEFINED, id=Component.UNDEFINED, unstyled=Component.UNDEFINED, sx=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'arrowOffset', 'arrowRadius', 'arrowSize', 'className', 'closeDelay', 'disabled', 'exitTransitionDuration', 'middlewares', 'offset', 'openDelay', 'position', 'radius', 'returnFocus', 'shadow', 'style', 'styles', 'sx', 'transition', 'transitionDuration', 'unstyled', 'width', 'withArrow', 'withinPortal', 'zIndex']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'arrowOffset', 'arrowRadius', 'arrowSize', 'className', 'closeDelay', 'disabled', 'exitTransitionDuration', 'middlewares', 'offset', 'openDelay', 'position', 'radius', 'returnFocus', 'shadow', 'style', 'styles', 'sx', 'transition', 'transitionDuration', 'unstyled', 'width', 'withArrow', 'withinPortal', 'zIndex']
